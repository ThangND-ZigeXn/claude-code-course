...
function NavProfileCard({ profile, expanded }) {
    ...
    if (utils.storage.getWindowVariable('suspendAnimations') && roles.length > 2) roles = [roles[0]]
    ...
    const statusCircleSize = expanded ? StatusCircle.Sizes.DEFAULT : StatusCircle.Sizes.SMALL
