...
function LanguageProvider({
    ...
    const allLanguages =
        Array.isArray(supportedLanguages) && supportedLanguages.length > 0 ? supportedLanguages : []
    ...
    useEffect(() => {
        ...
        const autoDetectedLanguage =
            allLanguages.find((language) => navigator.language.includes(language['id'])) ||
            defaultLanguage
    ...
    const getTranslation = (locales, key, customFallback) => {
        ...
        return customFallback !== undefined ? parseJsonText(customFallback) : 'locale:' + key
    }
    ...
    const getString = (key) => {
        const locales = appStrings && appStrings['locales'] ? appStrings['locales'] : {}
